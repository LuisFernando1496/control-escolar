...
} elseif ($_instance->childHasBeenRendered('2wsFefP')) {
    $componentId = $_instance->getRenderedChildComponentId('2wsFefP');
    $componentTag = $_instance->getRenderedChildComponentTagName('2wsFefP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2wsFefP');
} else {
    $response = \Livewire\Livewire::mount('notices.feed', []);
    $html = $response->html();
    $_instance->logRenderedChild('2wsFefP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH C:\Users\lenovo\Documents\xampp\htdocs\Telesis\resources\views/dashboard.blade.php ENDPATH**/ ?>