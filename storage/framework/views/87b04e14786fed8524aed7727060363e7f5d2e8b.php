 <?php $__env->slot('header'); ?> 
    ...
    <small><?php echo e($user->displayRoles()); ?></small>
 <?php $__env->endSlot(); ?>
            ...
            <div class="shadow overflow-hidden sm:rounded-md">
              <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <?php if(!Auth::user()->findRole('alumno')): ?>
                      <div class="col-span-6 sm:col-span-2">
                  ...
                  <?php if(Auth::user()->findRole('admin')): ?>
                      <div class="col-span-6 sm:col-span-2">
              ...
              <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                  ...
                  <button type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white <?php if($errors->count()>0): ?> bg-red-600 hover:bg-red-700 <?php else: ?>  bg-indigo-600 hover:bg-indigo-700 <?php endif; ?> focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                      Guardar
                  </button>
              </div>
            </div>
                  ...
                  <div class="px-4 py-5 bg-white sm:p-6">
                      <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-2">
                          ...
                          <input type="text" disabled name="address" id="address" value="<?php echo e($user->student->address); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                        <div class="col-span-6 sm:col-span-2">
                          <label for="strikes" class="block text-sm font-medium text-gray-700">Numero de reportes</label>
                          <input type="text" disabled name="strikes" id="strikes" value="<?php echo e($user->student->strikes); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                        <div class="col-span-6 sm:col-span-2">
                          <label for="tutor" class="block text-sm font-medium text-gray-700">Tutor</label>
                          <input type="text" disabled name="tutor" id="tutor" value="<?php echo e($user->student->tutor->name); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                        <div class="col-span-6 sm:col-span-2">
                          <label for="blood_id" class="block text-sm font-medium text-gray-700">Tipo de sangre</label>
                          <input type="text" disabled name="blood_id" id="blood_id" value="<?php echo e($user->student->blood->name); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                        <div class="col-span-6 sm:col-span-2">
                          <label for="behaviour" class="block text-sm font-medium text-gray-700">Comportamiento</label>
                          <input type="text" disabled name="behaviour" id="behaviour" value="<?php echo e($user->student->behaviour); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                        
                            <div class="col-span-6 sm:col-span-2">
                                <label for="banned" class="block text-sm font-medium text-gray-700">Expulsado</label>
                                <input type="text" disabled name="banned" id="banned" value="<?php echo e($user->student->banned? 'Si':'No'); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                            <?php if($user->student->banned): ?>
                                <div class="col-span-6 sm:col-span-2">
                                    <label for="banned_time" class="block text-sm font-medium text-gray-700">Expulsión Finaliza</label>
                                    <input type="text" disabled name="banned_time" id="banned_time" value="<?php echo e(\Carbon\Carbon::create($user->student->banned_time)->diffForHumans()); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                </div>
                            <?php endif; ?>
                        
                            <div class="col-span-6 sm:col-span-2">
                                <label for="paid" class="block text-sm font-medium text-gray-700">Pago realizado</label>
                                <input type="text" disabled name="paid" id="paid" value="<?php echo e($user->student->paid ? 'Si':'No'); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
...
<?php /**PATH C:\Users\carlos velazco\Documents\xampp\htdocs\Telesis\resources\views/livewire/user/update-component.blade.php ENDPATH**/ ?>