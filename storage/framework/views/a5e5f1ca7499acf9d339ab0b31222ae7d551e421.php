...
} elseif ($_instance->childHasBeenRendered('6iWBgwx')) {
    $componentId = $_instance->getRenderedChildComponentId('6iWBgwx');
    $componentTag = $_instance->getRenderedChildComponentTagName('6iWBgwx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6iWBgwx');
} else {
    $response = \Livewire\Livewire::mount('notices.feed', []);
    $html = $response->html();
    $_instance->logRenderedChild('6iWBgwx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Proyectos-T\Telesis\resources\views/dashboard.blade.php ENDPATH**/ ?>