                  ...
                  <div class="px-4 py-5 bg-white sm:p-6">
                      <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-2">
                          ...
                          <input type="text" disabled name="tutor" id="tutor" value="<?php echo e($user->student->tutor); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                        <div class="col-span-6 sm:col-span-2">
...
<?php /**PATH /Users/yamile/Documents/Residencia/FINAL/telesis/resources/views/livewire/user/update-component.blade.php ENDPATH**/ ?>