...
} elseif ($_instance->childHasBeenRendered('41aR0yk')) {
    $componentId = $_instance->getRenderedChildComponentId('41aR0yk');
    $componentTag = $_instance->getRenderedChildComponentTagName('41aR0yk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('41aR0yk');
} else {
    $response = \Livewire\Livewire::mount('notices.feed', []);
    $html = $response->html();
    $_instance->logRenderedChild('41aR0yk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?> 
<?php /**PATH C:\Users\carlos velazco\Documents\xampp\htdocs\Telesis\resources\views/dashboard.blade.php ENDPATH**/ ?>