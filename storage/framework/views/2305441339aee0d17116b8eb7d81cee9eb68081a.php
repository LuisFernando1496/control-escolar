		...
		<div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                ...
                <?php if(Route::has('login')): ?>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg">Iniciar sesion</a>
                    <?php endif; ?>
                <?php endif; ?>
			</div>
			<!--Right Col-->
...
<?php /**PATH C:\Users\carlos velazco\Documents\xampp\htdocs\Telesis\resources\views/welcome.blade.php ENDPATH**/ ?>