<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Maneja las sesiones en todos los dispositivos y navegadores.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si crees que tu contraseña ha sido vulnerada, puedes cerrar sesion en todos los dispositivos y cambiar tu contraseña.') }}
        </div>
